...
export function Footer() {
  return (
    <footer className="px-4 py-8 text-black bg-white sm:px-6 md:py-10 lg:px-8">
      <div className="grid grid-cols-1 gap-8 mx-auto sm:grid-cols-2 md:grid-cols-4 md:gap-8 max-w-7xl">
        <div>
          ...
          <div className="flex mt-4 space-x-4">
            <a href="https://facebook.com" className="text-gray-600 hover:text-red-600">
              <Facebook className="w-5 h-5" />
            </a>
            <a href="https://twitter.com" className="text-gray-600 hover:text-red-600">
              <Twitter className="w-5 h-5" />
            </a>
            <a href="https://instagram.com" className="text-gray-600 hover:text-red-600">
